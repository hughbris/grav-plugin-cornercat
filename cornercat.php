...
class CornercatPlugin extends Plugin
{
	...
	public function onPluginsInitialized(): void
	{
		...
		// TODO: source this by processing a Twig template
		$this->snippet = <<<EOS
		<a href="#" id="github-corner" aria-label="View source on GitHub">
			<svg width="80" height="80" viewBox="0 0 250 250" style="fill:{$this->options['fill']}; color:{$this->options['color']}; position: absolute; top: 0; border: 0; right: 0;" aria-hidden="true">
